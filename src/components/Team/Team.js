...
export default class Team extends Component {
  ...
  render() {
    ...
    const jin = (
      <p>
        Hi! I am a front-end developer/UI designer/photographer currently studying at the University of Washington in
        Seattle.
        I am focused on details and enjoy learning.
        I love creating new stuff from web pages to web extensions!
